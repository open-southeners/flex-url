 ...
 *   Symfony's `normalizeQueryString()` (behind `fullUrl()`, and so behind
 *   every Inertia response) rewrites `filter[a]=1,2` as
 ...
 *   either way: `,` is a `sub-delim`, so a raw comma is valid in a query.
